...
- 对比使用单个uuid主键和使用【crc32(uuid)+uuid】联合主键时的在【空表、百万、亿】的【查询、插入、更新、删除】性能差异有多大
...
- 看看在【空表、百万、亿】的【查询、插入、更新、删除】操作下，跟场景1的使用uuid作为主键的性能差异有多大
...
### 场景5
- 数据库使用Postgresql 16.11
- 表有四个字段(ID(内置的uuid类型), name, email, nickname)，
- 看看在【空表、百万、亿】的【查询、插入、更新、删除】操作下，跟场景1的使用uuid作为主键的性能差异有多大
...
- 数据库使用Postgresql 16.11
- 表有四个字段(ID(int64), name, email, nickname)，这次的ID使用snowflake算法生成
- 看看在【空表、百万、亿】的【查询、插入、更新、删除】操作下，跟场景5的使用内置uuid类型作为主键的性能差异有多大
